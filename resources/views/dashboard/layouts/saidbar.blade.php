<div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
    <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="sidebarMenuLabel">MNT blog</h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            @can('admin')
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-2 {{ Request::is('dashboard/allusers*') ? 'active' : '' }}"
            ...
            <ul class="nav flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="/dashboard/profiles"
                        class="nav-link d-flex align-items-center gap-2 {{ Request::is('dashboard/profile*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
